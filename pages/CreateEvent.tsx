    ...
    return (
        <div className="p-4">
            ...
            <form onSubmit={handleSubmit} className="bg-brand-secondary p-4 rounded-lg space-y-4">
                ...
                <button type="submit" disabled={loading} className="w-full bg-brand-accent text-white font-bold py-2 px-4 rounded-md hover:bg-blue-600 disabled:opacity-50 disabled:cursor-wait flex items-center justify-center">
                    {loading ? (
                        <>
